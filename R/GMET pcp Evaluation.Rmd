...
dir_main <- "https://github.com/seiwater/Gridded-precipitation-validation" # set your main directory
dir_GMET <- "Z:/Data/NCAR_GMET/GMET_grids/GMET_daily" # set the GMET.nc (netCDF large files) directory
dir_in <- "https://github.com/seiwater/Gridded-precipitation-validation" # set the input directory
```
