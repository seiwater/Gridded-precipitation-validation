...
dir_main <- "C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes" # set your main directory
dir_GMET <- "Z:/Data/NCAR_GMET/GMET_grids/GMET_daily" # set the GMET.nc (netCDF large files) directory
dir_in <- "C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Inputs" # set the input directory
```
...
* Copy and paste the "Coordinates_FileXY.csv" file, into your input directory. You can find it [here](https://github.com/seiwater/Gridded-precipitation-validation).  
* Copy and paste the "pcp txt files" folder into your input directory. You can find it [here](https://github.com/seiwater/Gridded-precipitation-validation)  
...
Purpose of this code is to calculate the monthly avg values over all grids. So for each month I only want one single raifall value either for obs or GMET which represents for the whole pixels. so average is taken over the pixels not time.  
...
Purpose of this section is to make two time series, one for the GMET and the other for reference observations and plot them against each other.  
```{r eval=FALSE}
...
```
![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/ScatterPlot_M.png)
  
# Section 11: Statistical Analysis (Daily, Monthly, Seasonal)
El enfoque de validación de la grilla se basa en la evaluación del desempeño del modelo sobre el territorio de Bolivia, usando un enfoque estadístico y de descomposición del error a diferentes escalas de tiempo diario, mensual y anual y para diferentes estaciones.  
Para la validación estadística se usaron las métricas de coeficiente de correlación (CC), error medio del sesgo (MBE), error de la raíz cuadrada (RMSE), coeficiente de variación del RMSE (CV-RMSE) y error medio absoluto (MAE). Therefore, the purpose of the following chunk is to calculate statistical measures over the daily dataset.
```{r eval=FALSE}
...
and the monthly statistical measures:  
```{r}
    setwd(dir_stats)
...
![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Daily_boxp_Corel.png)  

> Seasonal daily Mean Bias Error:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Daily_boxp_MBE.png)  

> Seasonal daily CV-RMSE:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Daily_boxp_CVRMSE.png)  

> Seasonal daily Mean Absolute Error:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Daily_boxp_MAE.png)  

> Seasonal monthly Correlation Coeficient:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Monthly_boxp_Corel.png)  

> Seasonal monthly Mean Bias Error:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Monthly_boxp_MBE.png)  

> Seasonal monthly CV-RMSE:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Monthly_boxp_CVRMSE.png)  

> Seasonal monthly Mean Absolute Error:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Monthly_boxp_MAE.png)  

# Section 12: Systematic and Random Error (Daily, Monthly, Seasonal)  
Purpose of this script is to calculate the systematic and random error components of the estimation model. In order to do that, we should initially perform a linear regression over the GMET-Gauge data and then based on the Sys-Rand formula we can calculate the systematic and random error components.  
```{r eval=FALSE}
...
![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Pie_sysrnd_Daily.png)  

> Monthly systematic and random error portions:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Pie_sysrnd_Monthly.png)  

> Seasonal daily systematic and random error portions:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Pie_Seasonal_sysrnd_Daily.png)  

> Seasonal monthly systematic and random error portions:  

![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Pie_Seasonal_sysrnd_Monthly.png)  
...
![](C:/Users/SEI_user/Documents/Bolivia/Calculation/Integrating all codes/Outputs/Stats/Categorical_Bar_Chart.png)
